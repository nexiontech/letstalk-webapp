...
export const SEO_CONFIG = {
  ...
  // Default Meta Tags
  defaultMeta: {
    title: "Let's Talk - South Africa's Premier Citizen Engagement Platform | Saya-Setona",
    ...
    keywords: 'South Africa, citizen engagement, municipal services, government services, community platform, service delivery, local government, public services, Saya-Setona, letstalkbi',
  ...
  pages: {
    home: {
      ...
      keywords: 'citizen engagement platform, municipal services South Africa, government services online, community platform, service reporting, local government, public services, civic engagement, digital government, smart city solutions',
      priority: 1.0,
      changefreq: 'daily'
    },
    about: {
      title: 'About Us - Let\'s Talk Platform | Saya-Setona',
      description: 'Learn about Let\'s Talk, South Africa\'s leading citizen engagement platform built by Saya-Setona. Discover our mission to connect communities with government services.',
      keywords: 'about Saya-Setona, citizen engagement platform, company information, mission vision values, South African technology company, government services platform, digital transformation, civic technology',
      priority: 0.8,
      changefreq: 'monthly'
    },
    services: {
    ...
    faq: {
      ...
      description: 'Find answers to common questions about using Let\'s Talk platform, municipal services, account management, payments, security, and technical support.',
  ...
  structuredData: {
    ...
    website: {
      ...
      "description": "South Africa's premier citizen engagement platform for municipal services, government services, and community interaction.",
      "publisher": {
        "@type": "Organization",
        "name": "Saya-Setona",
        "url": "https://saya-setona.co.za"
