...
const SEOHelmet = ({
  ...
  // Default values
  const defaultTitle =
    "Let's Talk - Municipal Services Platform for South Africa";
  const defaultDescription =
    "Transform your municipal service experience with Let's Talk. Pay bills, report issues, and engage with your community through South Africa's leading digital government platform.";
  const defaultKeywords =
    'municipal services, south africa, government services, digital transformation, local government, bill payment, service delivery';
    ...
    <Helmet>
      ...
      <script type="application/ld+json">
        {JSON.stringify({
          ...
          description:
            'Digital municipal services platform serving South African communities',
          url: siteUrl,
          telephone: '+27-11-123-4567',
          address: {
            '@type': 'PostalAddress',
      ...
      <script type="application/ld+json">
        {JSON.stringify({
          ...
          description:
            'Digital platform for accessing municipal services in South Africa',
          provider: {
            '@type': 'Organization',
            name: "Let's Talk",
          },
