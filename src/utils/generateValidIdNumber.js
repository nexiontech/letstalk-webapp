...
console.log('Female SA Citizen:', generateValidIdNumber({ gender: 'female', citizenship: 'citizen' }));
console.log('Male SA Citizen:', generateValidIdNumber({ gender: 'male', citizenship: 'citizen' }));
console.log('Female Permanent Resident:', generateValidIdNumber({ gender: 'female', citizenship: 'resident' }));
console.log('Male Permanent Resident:', generateValidIdNumber({ gender: 'male', citizenship: 'resident' }));
