...
export const SITE_PAGES = [
  {
    ...
    description: "Connect with municipal services, report issues, access government services, and engage with your community. South Africa's premier citizen engagement platform.",
    keywords: 'citizen engagement, municipal services, South Africa, government services, community platform',
    priority: 1.0,
    changefreq: 'daily',
    type: 'home'
  },
  {
    ...
    description: 'Learn about Let\'s Talk, South Africa\'s leading citizen engagement platform built by Saya-Setona to connect communities with government services.',
    keywords: 'about us, Saya-Setona, citizen engagement platform, South Africa, company information',
    priority: 0.8,
    changefreq: 'monthly',
    type: 'about'
  },
  {
    ...
    description: 'Discover our comprehensive range of municipal and government services including water services, electricity, community engagement, and more.',
    keywords: 'municipal services, government services, water services, electricity, community engagement, service delivery',
    priority: 0.9,
    changefreq: 'weekly',
    type: 'service'
  },
  {
    ...
    description: 'Find answers to common questions about using Let\'s Talk platform, municipal services, account management, and technical support.',
    keywords: 'FAQ, help, support, questions, answers, user guide, platform help',
    priority: 0.7,
    changefreq: 'monthly',
    type: 'faq'
  },
  {
    ...
    description: 'Stay updated with the latest news, announcements, and press releases from Let\'s Talk and Saya-Setona.',
    keywords: 'press releases, news, announcements, updates, media, Saya-Setona news',
    priority: 0.6,
    changefreq: 'weekly',
    type: 'news'
  },
  {
    ...
    description: 'Sign in to your Let\'s Talk account to access municipal services, report issues, and engage with your community.',
  ...
  },
  {
    ...
    description: 'Create your free Let\'s Talk account to start accessing municipal services, reporting issues, and engaging with your community.',
  ...
  },
  {
    ...
    description: 'Read our comprehensive privacy policy to understand how we protect and handle your personal information on the Let\'s Talk platform.',
  ...
  },
  {
    ...
    description: 'Review the terms and conditions for using the Let\'s Talk citizen engagement platform and our services.',
  ...
  },
  {
    ...
    description: 'Learn about how we use cookies and similar technologies to improve your experience on the Let\'s Talk platform.',
...
export const generateSitemap = () => {
  ...
  const urlEntries = SITE_PAGES.map(page => `
  <url>
...
export const generateSEOKeywords = (baseKeywords = [], pageType = '') => {
  const saKeywords = [
    'South Africa', 'SA', 'municipal services', 'local government',
    'citizen engagement', 'government services', 'community platform',
    'Saya-Setona', 'letstalkbi', 'service delivery'
  ];

  const pageSpecificKeywords = {
    home: ['citizen platform', 'municipal reporting', 'community engagement'],
    services: ['government services', 'municipal services', 'service delivery', 'public services'],
    community: ['community hub', 'citizen engagement', 'local community', 'neighborhood'],
    issues: ['service issues', 'municipal problems', 'infrastructure', 'utilities'],
