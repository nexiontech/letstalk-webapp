...
export const validateIdNumber = idNumber => {
  ...
  // const year = parseInt(idNumber.substring(0, 2), 10); // TODO: Use for age validation
...
export const validatePhoneNumber = phoneNumber => {
  ...
  if (!saPhoneRegex.test(cleanedNumber)) {
    return {
      isValid: false,
      error:
        'Please enter a valid South African phone number in +27 format (e.g., +27 XX XXX XXXX)',
    };
  }
 ...
 */
export const formatCognitoUser = (
  cognitoUser,
  hasIdentityPoolAccess = false
) => {
  ...
  return {
    ...
    customAttributes: {
      idNumber:
        cognitoUser.attributes?.['custom:idNumber'] || cognitoUser.username,
