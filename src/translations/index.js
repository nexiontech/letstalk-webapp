...
const translations = {
  ...
  en: {
    ...
    pressReleases: {
      ...
      subtitle:
        'Stay informed about service delivery news and government proceedings',
  ...
  af: {
    ...
    pressReleases: {
      ...
      selectNewsPrompt:
        "Kies 'n persverklaring om die volledige artikel te lees",
      selectMeetingPrompt:
        "Kies 'n vergadering om die regstreekse stroom of opname te kyk",
      live: 'Regstreeks',
      recorded: 'Opgeneem',
