            ...
            <div className="legal-content">
              <section className="legal-section">
                ...
                <Typography variant="body1" className="section-content">
                  Welcome to Let's Talk. We respect your privacy and are
                ...
                <Typography variant="body1" className="section-content">
                  This privacy policy applies to all personal information we
                  process about you when you use our services, visit our
                  website, mobile applications, or otherwise interact with us.
                </Typography>
              </section>
                ...
                <ul className="legal-list">
                  <li>
                    <Typography variant="body1">
                      <span className="list-title">Personal Identifiers:</span>{' '}
                      Such as your name, ID number, email address, postal
                      address, phone number, and other similar contact data.
                    </Typography>
                  </li>
                  <li>
                    <Typography variant="body1">
                      <span className="list-title">Account Information:</span>{' '}
                      Your username and password, account preferences, and
                      account activity.
                    </Typography>
                  </li>
                  <li>
                    <Typography variant="body1">
                      <span className="list-title">Service Data:</span>{' '}
                      Information about the services you access, the time, date,
                      and duration of your use of our services, and other
                      details about your interaction with our content.
                    </Typography>
                  </li>
                  <li>
                    <Typography variant="body1">
                      <span className="list-title">Location Data:</span> We
                      collect real-time information about the location of your
                      device, with your consent, to provide location-based
                      services.
                    </Typography>
                  </li>
                  <li>
                    <Typography variant="body1">
                      <span className="list-title">Technical Data:</span>{' '}
                      ...
                      technology on the devices you use to access our services.
                    </Typography>
                  </li>
                </ul>
              </section>
              ...
              <section className="legal-section">
                ...
                <ul className="legal-list">
                  <li>
                    <Typography variant="body1">
                      To provide and maintain our services, including to monitor
                      the usage of our services.
                    </Typography>
                  </li>
                  <li>
                    <Typography variant="body1">
                      To manage your account, including processing payments and
                      providing customer support.
                    </Typography>
                  </li>
                  <li>
                    <Typography variant="body1">
                      To contact you regarding your account, updates to our
                      terms or privacy policy, or other information we need to
                      share with you.
                    </Typography>
                  </li>
                  <li>
                  ...
                  <li>
                    <Typography variant="body1">
                      To improve our services, conduct research, and analyze
                      user behavior.
                    </Typography>
                  </li>
                </ul>
              ...
              <section className="legal-section">
                ...
                <ul className="legal-list">
                  <li>
                    <Typography variant="body1">
                      <span className="list-title">Consent:</span> We process
                      your data based on your explicit consent, which you can
                      withdraw at any time.
                    </Typography>
                  </li>
                  <li>
                    <Typography variant="body1">
                      <span className="list-title">Contract:</span> Processing
                  ...
                  <li>
                    <Typography variant="body1">
                      <span className="list-title">Legal Obligation:</span>{' '}
                  ...
                  <li>
                    <Typography variant="body1">
                      <span className="list-title">Legitimate Interests:</span>{' '}
              ...
              <section className="legal-section">
                ...
                <ul className="legal-list">
                  <li>
                    <Typography variant="body1">
                      <span className="list-title">Service Providers:</span>{' '}
                  ...
                  <li>
                    <Typography variant="body1">
                      <span className="list-title">Government Entities:</span>{' '}
                      We may share your information with relevant government
                      departments or municipalities to fulfill your service
                      requests or as required by law.
                    </Typography>
                  </li>
                  <li>
                    <Typography variant="body1">
                      <span className="list-title">Business Transfers:</span> If
                      we are involved in a merger, acquisition, or sale of all
                  ...
                  <li>
                    <Typography variant="body1">
                      <span className="list-title">With Your Consent:</span> We
              ...
              <section className="legal-section">
                ...
                <Typography variant="body1" className="section-content">
                  ...
                  designed to protect the personal information you provide
              ...
              <section className="legal-section">
                ...
                <Typography variant="body1" className="section-content">
                  Under South African data protection laws, you have rights
                  including:
                </Typography>
                <ul className="legal-list">
                  <li>
                    <Typography variant="body1">
                      <span className="list-title">Right to Access:</span> You
                      have the right to request copies of your personal
                      information.
                    </Typography>
                  </li>
                  <li>
                  ...
                  <li>
                    <Typography variant="body1">
                      <span className="list-title">Right to Erasure:</span> You
                      have the right to request that we erase your personal
                ...
                <Typography variant="body1" className="section-content">
                  ...
                  us at our email: privacy@letstalk.co.za
                </Typography>
              </section>
