  ...
  const issues = [
    {
      ...
      description:
        'Main water supply interrupted due to pipe damage. Repair crews are on site.',
      updates: [
        { time: '10:15', message: 'Repair crews have arrived on site' },
        { time: '11:30', message: 'Cause identified as broken main pipe' },
        {
          time: '13:45',
          message: 'Repairs underway, estimated completion by 16:30',
        },
      ],
    },
    {
      ...
      description:
        'Regular refuse collection delayed due to vehicle maintenance issues.',
      updates: [
    ...
    },
    {
      ...
      description:
        'Widespread power outage affecting multiple blocks. Emergency teams dispatched.',
      updates: [
    ...
    },
    {
      ...
      affected: 'Local area',
      description:
        'Minor water leak from street pipe. Non-emergency repair scheduled.',
      updates: [
        { time: '16:00 (Yesterday)', message: 'Leak reported and assessed' },
        {
          time: '09:00 (Today)',
          message: 'Repair scheduled for this afternoon',
        },
      ],
    },
  ];
              ...
              filteredIssues.map(issue => (
                ...
                >
                  <div className="issue-card-header">
                    <div
                      className="issue-icon-container"
                      style={{
                        backgroundColor: issueTypes[issue.iconType].bgColor,
                      }}
                    >
                      <FontAwesomeIcon
                        icon={issueTypes[issue.iconType].icon}
                        style={{ color: issueTypes[issue.iconType].color }}
                      />
                    </div>
            ...
            <div className="issue-details-panel">
              <div className="issue-details-header">
                <div className="issue-details-title">
                  <div
                    className="issue-icon-large"
                    style={{
                      backgroundColor:
                        issueTypes[selectedIssue.iconType].bgColor,
                    }}
                  >
                    <FontAwesomeIcon
                      icon={issueTypes[selectedIssue.iconType].icon}
                      style={{
                        color: issueTypes[selectedIssue.iconType].color,
                      }}
                    />
                  </div>
                  <div>
