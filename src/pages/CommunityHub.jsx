...
// import recordIcon from '../assets/images/record_icon.jpg'; // TODO: Use for voice recording feature
...
function CommunityHub() {
  ...
  const hasRealName =
    user?.name && user.name !== 'Guest User' && user.name.trim() !== '';
  ...
  const messages = [
    {
      ...
      avatar: bubleIcon,
      content:
        'Hello everyone! I wanted to share some information about the upcoming community meeting.',
      time: '10:30',
      isOutgoing: false,
    },
    {
      ...
      avatar: bubleIcon,
      content:
        'Thanks for the heads up. Will there be a discussion about the recent water issues?',
      time: '10:35',
      isOutgoing: false,
    },
    {
      ...
      avatar: circleIcon,
      content:
        "Yes, water services will be one of the main topics. We'll also discuss the new community garden project.",
      time: '10:40',
      isOutgoing: true,
    },
    {
    ...
    },
    {
      ...
      avatar: circleIcon,
      content:
        "I've reviewed the schedule. The maintenance times look good, but we should notify residents at least 48 hours in advance.",
      time: '11:30',
      isOutgoing: true,
    },
  ];
                  ...
                  {chats
                    .filter(
                      chat =>
                        ...
                        (activeTab === 'services' &&
                          chat.category === 'Service Updates')
                    )
                    .filter(
                      chat =>
                        chat.category === group.name ||
                    ...
                    <div className="hub-message-content">
                      ...
                      {message.isFile ? (
                        <div className="hub-message-file">
                          <FontAwesomeIcon
                            icon={faImage}
                            className="hub-file-icon"
                          />
                          <div className="hub-file-info">
                            <span className="hub-file-name">
                              {message.fileName}
                            </span>
                            <span className="hub-file-size">
                              {message.fileSize}
                            </span>
                          </div>
                        ...
                        <div className="hub-message-text">
                          {message.content}
                        </div>
                      )}
