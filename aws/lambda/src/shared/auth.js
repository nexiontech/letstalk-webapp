...
const CLIENT_SECRET = process.env.CLIENT_SECRET || '8vqu3hk27utkmfsel3ngm175ibab8iu5mpm967dqmb65ssagk9o';

/**
 * Calculate the SECRET_HASH value required for Cognito authentication
 ...
 * @param {string} username - The username (required for SECRET_HASH)
